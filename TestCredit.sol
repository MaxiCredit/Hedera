...
contract TestCredit {
    ...
    address MC2Address = 0x0000000000000000000000000000000000007f50;
    ...
    function createCreditOffer(uint _loanAmount, uint _loanType, uint _loanLength, uint _periodNumber, uint _interestRate, uint _minCreditScore, uint _lastTo) public {
        //require(tui.checkUsersAddress(msg.sender) == true); Needed
    ...
    */
    ...
    function acceptCreditOffer(uint _offerId, uint _amount) public {
        ...
        require(creditOffers[_offerId].lendersId != getSenderId(msg.sender));
    ...
    function acceptCreditClaim(uint _claimId, uint _amount) public {
        require(_amount >= 1000);
        require(creditClaims[_claimId].borrowersId != getSenderId(msg.sender));
